            ...
            <Drawer
                ...
                title={
                    <>
                        ...
                        <Avatar onClick={() => navigate('/teacher/profil')} style={{ cursor: 'pointer', position: 'absolute', right: 100, top: 33 }} radius="md" color="indigo">
                    ...
                    <Grid columns={11}>
                        <Col span={6}>
                            <span className="logoTitleTeacher" style={{ marginLeft: 15 }}>
                                <Link style={{ color: theme.colors.indigo[3], textDecoration: 'none' }} to="/teacher/forside">
